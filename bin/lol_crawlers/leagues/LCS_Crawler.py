...
url = 'https://oracleselixir.com/statistics/na/lcs-2020-summer-regular-season-team-statistics/'
...
i = 0
for line in dflist:
	sql = "INSERT INTO lcs (Team, Gp,W,L,agt,k,D,KD,CKPM,GPR,GSPD,EGR,MLR,GD15,FB,FT,F3T,HLD,FD,DRG,ELD,FBN,BN,LNE,JNG,WPM,CWPM,WCPM,Last_Updated, Image) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s, %s)"
...
path = "C:\\Users\Administrator\\Desktop\\Crawlers\\LeagueOfLegends\\LCS\\"
filename = "LCS-" + date + ".xlsx"
